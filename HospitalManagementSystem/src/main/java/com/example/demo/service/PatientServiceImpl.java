...
public class PatientServiceImpl implements PatientService{
	...
	public PatientResponseDTO createPatient(PatientRequestDTO dto) {
		...
		Patient fetchedPatient = patientMapper.toEntity(dto,doctor);
		return patientMapper.toDTO(patientRepository.save(fetchedPatient));
	}
	...
	public PatientResponseDTO updatePatientById(Long id,PatientRequestDTO dto) {
		Patient fetchedPatient =  patientRepository.findById(id).orElseThrow(
				() -> new PatientNotFoundException("Patient Not Found"));
		fetchedPatient.setMedicalHistory(dto.getMedicalHistory());
		return patientMapper.toDTO(patientRepository.save(fetchedPatient));
	}
}
